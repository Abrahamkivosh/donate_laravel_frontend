...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('auth/assets/css/material-dashboard.css') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
                                    ...
                                    <li class="mb-2">
                                        <a class="dropdown-item border-radius-md" href="javascript:;">
                                            <div class="d-flex py-1">
                                                <div class="my-auto">
                                                    <img src="{{ asset('auth/assets/img/team-2.jpg') }}"
    ...
    <script src="{{ asset('auth/assets/js/plugins/perfect-scrollbar.min.j') }}s"></script>
    ...
    <script src="{{ asset('auth/assets/js/material-dashboard.min.js?v=3.2.0') }}"></script>
    @yield('scripts')
</body>
